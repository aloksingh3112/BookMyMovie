...
func Setup() *gorm.DB {
	...
	db.AutoMigrate(&models.Movie{}, &models.Theatre{}, &models.Booking{}, &models.Seat{}, &models.User{}, &models.MovieDate{}, &models.Date{}, &models.Time{}, &models.Seat{}, &models.TheatreTime{}, &models.MovieTheatre{}, &models.MovieTime{}, &models.DateTheatre{}, &models.SeatMap{})
	return db
